...
class MobileSignupScreenUI extends StatefulWidget {
  const MobileSignupScreenUI({super.key});

  @override
  State<MobileSignupScreenUI> createState() => _MobileSignupScreenUIState();
}

class _MobileSignupScreenUIState extends State<MobileSignupScreenUI> {
      ...
      if (auth.currentUser == null) {
        WzToast.show(
          ...
          message: AppLocalizations.of(
            context,
          )!.translate('please_signup_google_first'),
  ...
  Future<void> _sendOtp() async {
    ...
    if (!mounted) return;
    if (success) {
      Navigator.pushNamed(context, AppRoutes.signupOtp, arguments: phoneNumber);
    }
  }
